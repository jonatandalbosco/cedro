                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <div class="single-product-item">
                                    <div class="img-holder">
                                        <img src="images/marca-produtos/apple-logo.jpg.png" alt="Awesome Product Image">
                                        <div class="overlay-box">
                                            <div class="box">
                                                <div class="content">
                                                    <a class="thm-btn bg-1" href="sub-marca/produtos-apple.php">Ver agora</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="title-holder">
                                        <div class="top clearfix">
                                            <div class="product-title text-center">
                                                <a href="sub-marca/produtos-apple.php">
                                                    <h5>APPLE</h5>
                                                </a>
                                            </div>
                                        </div>
